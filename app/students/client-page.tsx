...
const StudentsContent = () => {
  ...
  const editingStudent = editingStudentId
    ? {
      ...studentLookup[editingStudentId],
      ...studentMeta[editingStudentId]  // دمج بيانات meta هنا
    }
    : undefined;
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="w-full z-auto max-w-sm space-y-2">
        ...
        <div className="rounded-2xl z-0 border border-border/60 bg-white/90 p-5 shadow-sm backdrop-blur space-y-4">
